(function () {
  ...
  function applyFormStyle() {
    ...
    styleLi("li_8", 50, "1 / -1");
    styleLi("li_9", 60, "1 / 2");
    styleLi("li_10", 70, "2 / 3");
    styleLi("li_11", 80, "1 / 2");
    styleLi("li_12", 90, "1 / -1");
    ...
    console.log("Banesco PDV formulario aplicado correctamente.");
    return true;
  }

  function removeConfirmationGrayBar(formContainer, thankYou) {
    Array.from(formContainer.querySelectorAll("*")).forEach(function (el) {
      if (el === thankYou || thankYou.contains(el)) return;
      if (el.querySelector && el.querySelector("#banesco-thankyou-message")) return;
      ...
      var looksLikeGrayHeader =
        ...
        (
          ...
          bg.indexOf("rgb(80") === 0 ||
          bg.indexOf("rgb(90") === 0 ||
          bg.indexOf("rgb(100") === 0 ||
          bg.indexOf("rgb(110") === 0 ||
          bg.indexOf("rgb(120") === 0
        );

      if (looksLikeGrayHeader) {
        hide(el);
      }
    });
  }

  function styleConfirmation() {
    var thankYou = get("banesco-thankyou-message");
    if (!thankYou) return false;

    var formContainer = get(CONFIG.containerId) || thankYou.closest("div") || document.body;
    ...
    removeConfirmationGrayBar(formContainer, thankYou);

    console.log("Banesco PDV confirmación aplicada correctamente.");
    return true;
  }
  ...
  function keepCheckingConfirmation() {
    styleConfirmation();
  }
  ...
  setInterval(keepCheckingConfirmation, 500);
})();
