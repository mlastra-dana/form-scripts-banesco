(function () {
  ...
  function injectCSS() {
    if (document.getElementById("banesco-pdv-final-v21-css")) return;

    var style = document.createElement("style");
    style.id = "banesco-pdv-final-v21-css";
    ...
    style.innerHTML = `
      ...
      /*
        ...
        de los wrappers internos de ExtJS para no romper selects.
      */
  ...
  function clearClassification(block) {
  ...
  function hideOldDecorativeTexts(container) {
  ...
  function buildLayout(container) {
    ...
    shell.className = "banesco-final-shell";

    var card = document.createElement("div");
    card.className = "banesco-final-card";
    ...
    hideOldDecorativeTexts(container);
  ...
  function hideGrayBars() {
    ...
    candidates.forEach(function (el) {
      ...
      if (
        el.classList &&
        (
          el.classList.contains("banesco-final-shell") ||
          el.classList.contains("banesco-final-card")
        )
      ) {
        return;
      }
  ...
  function apply() {
    ...
    if (ok && !applied) {
      applied = true;
      console.log("Banesco PDV final clean v21 aplicado correctamente.");
    }
