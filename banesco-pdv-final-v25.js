(function () {
  ...
  function injectCSS() {
    if (document.getElementById("banesco-pdv-final-v24-css")) return;

    var style = document.createElement("style");
    style.id = "banesco-pdv-final-v24-css";
    ...
    style.innerHTML = `
      ...
      /* Forzar ocultamiento de cabeceras de DANA */
      .x-panel-header,
      .x-window-header,
      .x-header,
      .x-toolbar,
      ...
      /* MÁSCARA BLANCA: Tapará cualquier barra gris rebelde en la parte superior del iframe */
      .banesco-card::before {
        content: "" !important;
      ...
      .banesco-form-root {
        position: relative !important;
        z-index: 2 !important; /* Encima de la máscara */
        width: 100% !important;
        margin: 0 !important;
        padding: 0 !important;
        background: transparent !important;
      ...
      .banesco-field-actividad { order: 20 !important; grid-column: 2 / 3 !important; }
      ...
      .banesco-field-persona { order: 50 !important; grid-column: 1 / -1 !important; }
      .banesco-field-correo { order: 60 !important; grid-column: 1 / 2 !important; }
      .banesco-field-telefono { order: 70 !important; grid-column: 2 / 3 !important; }
      .banesco-field-estado { order: 80 !important; grid-column: 1 / 2 !important; }
      .banesco-field-agencia { order: 90 !important; grid-column: 1 / -1 !important; }
      ...
      /* DEVOLVIENDO EL COLOR VERDE A LAS ETIQUETAS */
      ...
      .x-form-required-field {
        color: #f04a3a !important; /* Rojo sutil para asteriscos, o cámbialo a #007a63 si lo quieres verde */
      }
      ...
      .banesco-field .x-form-field {
        ...
        border: 1px solid #d8d8d8 !important; /* Caja sutil como en tu captura */
  ...
  function killExtJSHeaders() {
    var headers = document.querySelectorAll(".x-panel-header, .x-window-header, .x-docked-top, .x-panel-header-default");
  ...
  function forceColors() {
    var titles = document.querySelectorAll(".banesco-title, .banesco-field label, .x-form-item-label, .x-form-cb-label");
  ...
  function apply() {
    ...
    if (ok) {
      console.log("Banesco PDV final v24 aplicado correctamente.");
    }
