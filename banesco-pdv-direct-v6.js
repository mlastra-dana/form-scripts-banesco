(function () {
  ...
  function injectCSS() {
    if (document.getElementById("banesco-pdv-direct-v6-css")) return;

    var style = document.createElement("style");
    style.id = "banesco-pdv-direct-v6-css";
  ...
  function apply() {
    ...
    if (ok) {
      console.log("Banesco PDV direct v6 aplicado correctamente.");
      return true;
    }
