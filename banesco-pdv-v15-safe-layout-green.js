(function () {
  ...
  function injectCSS() {
    if (document.getElementById("banesco-pdv-v15-safe-green-css")) return;

    var style = document.createElement("style");
    style.id = "banesco-pdv-v15-safe-green-css";
  ...
  function apply() {
    ...
    if (ok) {
      console.log("Banesco PDV v15 safe layout green aplicado correctamente.");
    }
