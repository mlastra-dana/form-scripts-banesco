(function () {
  ...
  function injectCSS() {
    if (document.getElementById("banesco-pdv-popup-v7-css")) return;

    var style = document.createElement("style");
    style.id = "banesco-pdv-popup-v7-css";
    ...
    style.innerHTML = `
      ...
      /* Ocultar headers / barras nativas */
      .x-panel-header,
      .x-window-header,
      .x-header,
      .x-toolbar,
      ...
      .banesco-popup-card {
        ...
        padding: 34px 44px 34px 44px !important;
        box-shadow: 0 6px 20px rgba(0, 0, 0, 0.04) !important;
        border: 0 !important;
        overflow: hidden !important;
      }

      /* Quitar cualquier barra/strip gris que quede */
      .banesco-force-hide {
        display: none !important;
      }
  ...
  function hideTopGrayBars() {
    var candidates = Array.prototype.slice.call(document.querySelectorAll("div, section, header"));
    ...
    candidates.forEach(function (el) {
      ...
      if ((looksGray && h > 20 && h < 100 && txt === "") || (h > 20 && h < 90 && txt === "" && el.offsetWidth > 300)) {
  ...
  function apply() {
    ...
    if (ok) {
      console.log("Banesco PDV popup v7 aplicado correctamente.");
      return true;
    }
