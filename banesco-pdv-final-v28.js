(function () {
  ...
  function injectCSS() {
    ...
    style.innerHTML = `
      ...
      /* Cubre definitivamente la barra gris interna superior */
      .banesco-top-cover {
      ...
      /*
        No tocar display/visibility/position/pointer-events
        de ExtJS para no romper combos/selects.
      */
  ...
  function buildLayout(container) {
    ...
    cover.className = "banesco-top-cover";

    var title = document.createElement("div");
    title.className = "banesco-title";
    title.textContent = "¡Nos acercamos a ti!";
    title.style.setProperty("color", "#007a63", "important");
    ...
    candidates.forEach(function (el) {
      ...
      if (
        ...
        (
          ...
          el.classList.contains("banesco-top-cover")
        )
      ) {
        return;
      }
