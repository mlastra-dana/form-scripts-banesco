(function () {
  ...
  function injectCSS() {
    if (document.getElementById("banesco-pdv-popup-v8-css")) return;

    var style = document.createElement("style");
    style.id = "banesco-pdv-popup-v8-css";
    ...
    style.innerHTML = `
      ...
      /* Labels: verde más fuerte */
      .x-form-item-label,
      .x-form-cb-label,
      label {
        color: #2b8b78 !important;
  ...
  function apply() {
    ...
    if (ok) {
      console.log("Banesco PDV popup v8 aplicado correctamente.");
      return true;
    }
